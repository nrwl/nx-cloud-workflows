  ...
  async function runNvmInstall(version, maxRetries = 3) {
    ...
    while (retryCount < maxRetries) {
      try {
        ...
        console.warn('Failed to install node version using nvm, retrying...');
        console.warn(e);
        ...
        const delay = Math.pow(2, retryCount) * Math.random() * 1_250;
        console.log(`Retrying install in ${delay.toFixed(2)} seconds...`);
