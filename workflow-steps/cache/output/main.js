...
var require_glob = __commonJS({
  '../../node_modules/glob/glob.js'(exports, module2) {
    ...
    Glob.prototype._readdirInGlobStar = function (abs, cb) {
      ...
      if (lstatcb) fs2.lstat(abs, lstatcb);
    ...
    Glob.prototype._stat = function (f, cb) {
      ...
      if (statcb) fs2.lstat(abs, statcb);
      function lstatcb_(er, lstat) {
        if (lstat && lstat.isSymbolicLink()) {
...
function makeMessageType(runtime, typeName, fields, opt) {
  var _a;
  const localName =
    (_a = opt === null || opt === void 0 ? void 0 : opt.localName) !== null &&
    _a !== void 0
      ? _a
...
function makeBinaryFormatCommon() {
  return {
    ...
    listUnknownFields(message) {
      var _a;
      return (_a = message[unknownFieldsSymbol]) !== null && _a !== void 0
        ? _a
        : [];
    },
...
function writeEnum(type, value, emitIntrinsicDefault, enumAsInteger) {
  ...
  return (_a = val === null || val === void 0 ? void 0 : val.name) !== null &&
    _a !== void 0
    ? _a
    : value;
}
      ...
      if (field.kind == 'map') {
        ...
        switch (field.kind) {
          ...
          case 'enum':
            for (let i = 0; i < value.length; i++) {
              jsonArr.push(
                writeEnum2(field.T, value[i], true, options.enumAsInteger),
              );
            }
            break;
          case 'message':
      ...
      for (const member of type.fields.byMember()) {
        ...
        switch (member.kind) {
          ...
          case 'message':
            const mt = member.T;
            if (member.repeated) {
              t[localName] = s[localName].map((val2) =>
                val2 instanceof mt ? val2 : new mt(val2),
              );
      ...
      return type.fields.byMember().every((m) => {
        ...
        if (m.repeated) {
          ...
          switch (m.kind) {
            ...
            case 'enum':
              return va.every((a2, i) =>
                scalarEquals(ScalarType.INT32, a2, vb[i]),
              );
          }
...
var proto3 = makeProtoRuntime(
  ...
  Object.assign(Object.assign({}, makeUtilCommon()), {
    newFieldList(fields) {
...
function normalizeFieldInfosProto3(fieldInfos) {
  ...
  for (const field of typeof fieldInfos == 'function'
    ...
    f.jsonName =
      (_a = field.jsonName) !== null && _a !== void 0
        ? _a
        : fieldJsonName(field.name);
    f.repeated = (_b = field.repeated) !== null && _b !== void 0 ? _b : false;
    f.packed =
      (_c = field.packed) !== null && _c !== void 0
        ? _c
        : field.kind == 'enum' ||
          (field.kind == 'scalar' &&
...
(function (MethodIdempotency2) {
  MethodIdempotency2[(MethodIdempotency2['NoSideEffects'] = 1)] =
    'NoSideEffects';
...
var ConnectError = class _ConnectError extends Error {
  ...
  constructor(message, code = Code.Unknown, metadata, outgoingDetails, cause) {
    ...
    this.details =
      outgoingDetails !== null && outgoingDetails !== void 0
        ? outgoingDetails
        : [];
    this.cause = cause;
  }
      ...
      'typeName' in typeOrRegistry
        ? {
            findMessage: (typeName) =>
              typeName === typeOrRegistry.typeName ? typeOrRegistry : void 0,
          }
        : typeOrRegistry;
    const details = [];
...
function makeAnyClient(service, createMethod) {
  ...
  for (const [localName, methodInfo] of Object.entries(service.methods)) {
    const method = createMethod(
      Object.assign(Object.assign({}, methodInfo), {
        localName,
        service,
      }),
    );
...
function createClientStreamingFn(transport, service, method) {
  return async function (request, options) {
    ...
    (_d =
      ...
      null || _d === void 0
      ? void 0
      : _d.call(options, response.header);
    let singleMessage;
    try {
      for (
        var _f = true, _g = __asyncValues2(response.message), _h;
        (_h = await _g.next()), (_a = _h.done), !_a;
        _f = true
      ) {
        _c = _h.value;
        _f = false;
    ...
    (_e =
      ...
      null || _e === void 0
      ? void 0
      : _e.call(options, response.trailer);
  ...
  const it = (function () {
    ...
    return __asyncGenerator2(this, arguments, function* () {
      ...
      (_a =
        ...
        : _a.call(options, response.header);
      yield __await2(
        yield* __asyncDelegator2(__asyncValues2(response.message)),
      );
      (_b =
        options === null || options === void 0 ? void 0 : options.onTrailer) ===
        null || _b === void 0
...
function getJsonOptions(options) {
  ...
  (_a = o.ignoreUnknownFields) !== null && _a !== void 0
    ? _a
...
function createJsonSerialization(messageType, options) {
  ...
  const textEncoder =
    (_a =
      options === null || options === void 0 ? void 0 : options.textEncoder) !==
      null && _a !== void 0
      ? _a
      : new TextEncoder();
  const textDecoder =
    (_b =
      options === null || options === void 0 ? void 0 : options.textDecoder) !==
      null && _b !== void 0
      ? _b
      : new TextDecoder();
...
function parseContentType(contentType) {
  const match =
    contentType === null || contentType === void 0
      ? void 0
      : contentType.match(contentTypeRegExp);
  if (!match) {
    return void 0;
  }
...
function errorFromJson(jsonValue, metadata, fallback2) {
  if (metadata) {
    new Headers(metadata).forEach((value, key2) =>
      fallback2.metadata.append(key2, value),
    );
  }
  if (
...
function requestHeader(
  ...
  const result = new Headers(
    userProvidedHeaders !== null && userProvidedHeaders !== void 0
      ? userProvidedHeaders
      : {},
  );
  if (timeoutMs !== void 0) {
...
function transformConnectPostToGetRequest(request, message, useBase64) {
  ...
  if (
    (contentType === null || contentType === void 0
      ? void 0
      : contentType.indexOf(contentTypePrefix)) === 0
  ) {
    query +=
      '&encoding=' +
...
function runStreamingCall(opt) {
  ...
  signal.addEventListener('abort', function () {
    ...
    if (!doneCalled) {
      (_a = it.throw) === null || _a === void 0
        ? void 0
        : _a.call(it, this.reason).catch(() => {});
    }
    (_b = it.return) === null || _b === void 0
      ? void 0
      : _b.call(it).catch(() => {});
  });
  return next(req).then((res) => {
...
function createConnectTransport(options) {
  ...
  const useBinaryFormat =
    (_a = options.useBinaryFormat) !== null && _a !== void 0 ? _a : false;
  return {
      ...
      return await runUnaryCall({
        ...
        req: {
          ...
          init: {
            method: 'POST',
            credentials:
              (_a2 = options.credentials) !== null && _a2 !== void 0
                ? _a2
                : 'same-origin',
            redirect: 'error',
            mode: 'cors',
        ...
        next: async (req) => {
          ...
          const fetch =
            (_a3 = options.fetch) !== null && _a3 !== void 0
              ? _a3
              : globalThis.fetch;
          const response = await fetch(
            req.url,
            Object.assign(Object.assign({}, req.init), {
              headers: req.header,
              signal: req.signal,
              body,
            }),
          ...
          function* parseResponseBody_1() {
            ...
            for (;;) {
              ...
              if ((flags & endStreamFlag) === endStreamFlag) {
                ...
                endStream.metadata.forEach((value, key2) =>
                  trailerTarget.set(key2, value),
                );
                continue;
              }
